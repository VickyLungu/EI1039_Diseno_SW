...
// Make "Sabina's hits" playlist and add 2 songs to it
        ...
        sabinaPlaylist.add(new SongDecoratorVinyl(new Song("Princesa", "Joaquín Sabina")));
...
// Make "Manolo García's hits" playlist and add 3 song to it
        ...
        garciaPlaylist.add(new SongDecoratorMP4(new Song("Pájaros de barro", "Manolo García")));
